(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~favorite-doctors-favorite-doctors-module~search-page-search-page-module"], {
        ...
        _createClass(SearchService, [{
          ...
          value: function postSearchQuery() {
            ...
            return this.dataService.post('api/doctor_search_query', {
              ...
              _this.doctors = res.result;
              _this.searchDoctors = _this.doctors;
            }, function (error) {}, function () {
              _this.getAllFavoriteDoctors();
            });
          }
        }, {
          key: "getAllFavoriteDoctors",
          value: function getAllFavoriteDoctors() {
            ...
            this.favoritesService.getAllFavoriteDoctors().subscribe(function (res) {
              _this2.favoriteIds = res.result.favorite_doctors;
              console.log(_this2.favoriteIds);
            }, function (error) {}, function () {
              _this2.getFavoriteDoctorsFiltered();
            });
          }
        }, {
            ...
            if (this.doctors) {
              this.doctors.forEach(function (c) {
                var OBJ = {
                  ...
                  isFavorite: _this3.checkInFavoriteList(c.id)
                };

                _this3.favoriteDoctorsFiltered.push(OBJ);
              });
            }
    ...
    function srcAppSharedComponentsCardCardComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var src_app_Service_search_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! src/app/Service/search.service */
      "./src/app/Service/search.service.ts");

      var CardComponent = /*#__PURE__*/function () {
        function CardComponent(router, nativeStorage, searchService) {
          _classCallCheck(this, CardComponent);

          this.router = router;
          this.nativeStorage = nativeStorage;
          this.searchService = searchService; // tslint:disable-next-line:no-output-native
        ...
        _createClass(CardComponent, [{
          ...
          key: "onClickRemoveFavorite",
          value: function onClickRemoveFavorite() {
      ...
      CardComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        "./node_modules/raw-loader/dist/cjs.js!./src/app/SharedComponents/card/card.component.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./card.component.scss */
        "./src/app/SharedComponents/card/card.component.scss"))["default"]]
      })], CardComponent);
      /***/
    },
    ...
    function srcAppSharedComponentsSharedComponentsModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var ionic_rating_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ionic-rating-component */
      ...
      SharedComponentsModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], ionic_rating_component__WEBPACK_IMPORTED_MODULE_5__["IonicRatingComponentModule"]]
      })], SharedComponentsModule);
      /***/
    }
  }]);
})();
//# sourceMappingURL=default~favorite-doctors-favorite-doctors-module~search-page-search-page-module-es5.js.map